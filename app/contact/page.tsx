         ...
         <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div className="space-y-8">
               ...
               <div className="space-y-8 mt-8">
                  ...
                  <div className="flex items-center gap-5 group">
                     <Link href="https://t.me/restalinua" target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-accent/10 text-accent group-hover:bg-accent group-hover:text-white transition-colors duration-300">
                        <Send className="w-6 h-6" />
                     </Link>
                     <div>
                        <h3 className="font-medium text-lg">Telegram</h3>
                        <p className="text-secondary">@restalinua</p>
                     </div>
                  </div>

                  <div className="pt-8 border-t border-white/10">
                     <h3 className="text-xl font-light text-white mb-8">Партнери-Офіси</h3>
                     <div className="space-y-8">
                        <div className="flex items-center gap-5 group">
                           <Link href="https://maps.app.goo.gl/Vf5dhgpD4z8Xec7y7" target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-accent/10 text-accent group-hover:bg-accent group-hover:text-white transition-colors duration-300">
                              <MapPin className="w-6 h-6" />
                           </Link>
                           <div>
                              <h3 className="font-medium text-xl text-orange-500/80">JoinUp Турагенція</h3>
                              <p className="text-secondary">ТЦ Монблан, пров. С.Бандери, 2/1а, Хмельницький</p>
                           </div>
                        </div>

                        <div className="flex items-center gap-5 group">
                           <Link href="https://maps.app.goo.gl/scqauCGqKePULwXTA" target="_blank" rel="noopener noreferrer" className="p-4 rounded-2xl bg-accent/10 text-accent group-hover:bg-accent group-hover:text-white transition-colors duration-300">
                              <MapPin className="w-6 h-6" />
                           </Link>
                           <div>
                              <h3 className="font-medium text-xl text-red-500/80">Anex Турагенція</h3>
                              <p className="text-secondary">ТЦ Агора, вул. Ст.Шосе, 2/1А, Хмельницький</p>
                           </div>
                        </div>
                     </div>
                  </div>
