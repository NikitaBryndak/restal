                        ...
                        <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-blue-500/10 border border-blue-400/30 rounded-lg p-4">
                                    <p className="text-xs uppercase tracking-wider text-blue-300 mb-2">Дата початку</p>
                                    <p className="text-2xl font-bold text-white">{trip.tripStartDate}</p>
                                </div>
                                <div className="bg-purple-500/10 border border-purple-400/30 rounded-lg p-4">
                                    <p className="text-xs uppercase tracking-wider text-purple-300 mb-2">Дата закінчення</p>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start justify-between">
                                    ...
                                    <div className="bg-amber-500/20 border border-amber-400/40 rounded-full px-4 py-2">
                                        <span className="text-amber-300 font-bold">{trip.hotel.nights} ночей</span>
                                    </div>
                                </div>
