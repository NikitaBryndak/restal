...
async function getTripData(id: string): Promise<EnrichedTrip | null> {
  try {
    ...
    if (trip.ownerPhone) {
      const client = await UserModel.findOne({ phoneNumber: trip.ownerPhone })
        .select("name")
        .lean();
...
export default async function TripPage({
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Подорож, яку ви шукаєте, не існує, або ви не маєте дозволу на
            перегляд.
          </p>
        </div>
      </div>
  ...
  const cashback =
    trip.cashbackAmount && trip.cashbackAmount > 0
      ? trip.cashbackAmount
  ...
  // Group documents
  const mainDocKeys: (keyof Documents)[] = [
    "contract",
    "invoice",
    "confirmation",
    "voucher",
  ...
  const departureTicketKeys: (keyof Documents)[] = [
    "departureTicket1",
    "departureTicket2",
    "departureTicket3",
    "departureTicket4",
  ];
  const arrivalTicketKeys: (keyof Documents)[] = [
    "arrivalTicket1",
    "arrivalTicket2",
    "arrivalTicket3",
    "arrivalTicket4",
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-8">
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3 sm:gap-4">
              <div className="min-w-0">
                <div
                  className={`inline-block px-3 py-1 rounded-full text-xs sm:text-sm font-semibold border mb-2 sm:mb-3 ${statusColors[status]}`}
                >
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10">
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                <div className="bg-blue-500/10 border border-blue-400/30 rounded-lg p-3 sm:p-4">
                  <p className="text-[10px] sm:text-xs uppercase tracking-wider text-blue-300 mb-1 sm:mb-2">
                    Дата початку
                  </p>
                ...
                <div className="bg-purple-500/10 border border-purple-400/30 rounded-lg p-3 sm:p-4">
                  <p className="text-[10px] sm:text-xs uppercase tracking-wider text-purple-300 mb-1 sm:mb-2">
                    Дата закінчення
                  </p>
                  <p className="text-base sm:text-2xl font-bold text-white">
                    {trip.tripEndDate}
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-sm uppercase tracking-wider text-white/70 font-semibold">
                      Виліт
                    </h3>
                  </div>
                  <div className="pl-4 space-y-2">
                    <div>
                      ...
                      <p className="text-lg font-bold text-white">
                        ...
                        {trip.flightInfo.departure.flightNumber}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs text-white/60">Країна</p>
                      <p className="text-base text-white">
                        {trip.flightInfo.departure.country}
                      </p>
                    </div>
                    <div className="flex items-center gap-3 pt-2">
                      ...
                      <div className="flex items-center gap-1.5 text-white/80">
                        ...
                        <span className="text-sm">
                          {trip.flightInfo.departure.time}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pl-4 space-y-2">
                    <div>
                      ...
                      <p className="text-lg font-bold text-white">
                        ...
                        {trip.flightInfo.arrival.flightNumber}
                      </p>
                    </div>
                    <div>
                      <p className="text-xs text-white/60">Країна</p>
                      <p className="text-base text-white">
                        {trip.flightInfo.arrival.country}
                      </p>
                    </div>
                    <div className="flex items-center gap-3 pt-2">
                      <div className="flex items-center gap-1.5 text-white/80">
                    ...
                    <div className="space-y-1 pl-1">
                      {tourist.dob && (
                        <p className="text-sm text-white/70">
                          <span className="text-white/50">Дата нар.:</span>{" "}
                          {tourist.dob}
                        </p>
                      )}
                      <p className="text-sm text-white/70">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/10">
              ...
              <div className="space-y-4">
                <div className="bg-linear-to-br from-green-500/10 to-emerald-500/10 border border-green-400/30 rounded-xl p-4">
                  <p className="text-xs uppercase tracking-wider text-green-300 mb-2">
                    Загальна сума
                  </p>
                ...
                <div className="bg-linear-to-br from-amber-500/10 to-orange-500/10 border border-amber-400/30 rounded-xl p-4">
                  ...
                  <p className="text-sm text-white/80 leading-relaxed">
                    Будь ласка, зверніться до вашого менеджера для уточнення
                    залишку. Сума доплати розраховується за курсом євро на день
                    фактичного розрахунку, тому вона може дещо змінюватися.
                  </p>
                </div>
              </div>
            </div>
                ...
                {mainDocKeys.map((key) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-xs text-center text-white/90">
                        {DOCUMENT_LABELS[key]}
                      </span>
                      {doc?.uploaded && (
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                ...
                <p className="text-sm text-white/50">
                  Замовте схожий тур до {trip.country} знову!
                </p>
              </div>
              <Link
