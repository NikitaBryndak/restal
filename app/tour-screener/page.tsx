    ...
    useEffect(() => {
        ...
        const initScripts = async () => {
            try {
                ...
                // 2. Onsite script - append to document.body, widget will find containers by ID
                await loadScript("https://export.otpusk.com/js/onsite/");
...
`}} />
                <div className="w-full max-w-6xl mx-auto">
                    ...
                    {/* Single container for the entire widget - form AND results */}
                    <div
                        ref={containerRef}
                        id="new_os"
                        className="w-full"
